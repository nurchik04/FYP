        ...
        <div className="bg-main mt-[6rem]">
            <footer className="footer footer-center p-10 text-primary-content">
                <aside>
                    ...
                    <p className='text-sub font-semibold  mt-5'>Developed by NURCHIK</p>
                    <div className='flex justify-center items-center gap-5 text-white'>
                        <a href='#' target='_blank' rel="noreferrer" className='single-nav-menu'>Portfolio</a>
                        <a href='#' target='_blank' rel="noreferrer" className='single-nav-menu'>LinkedIn</a>
                        <a href='#' target='_blank' rel="noreferrer" className='single-nav-menu'>Github</a>
                    </div>
                </aside>
            </footer>
        </div>
